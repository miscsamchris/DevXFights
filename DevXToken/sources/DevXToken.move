...
module DevXToken::devx_token {
    ...
    const ASSET_SYMBOL: vector<u8> = b"DEVX";
    ...
    public fun get_metadata(): Object<Metadata> {
        let asset_address = object::create_object_address(&@DevXToken, ASSET_SYMBOL);
    ...
    #[test(creator = @DevXToken, aaron = @0xface)]
